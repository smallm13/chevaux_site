...
Route::get('/utilisateurs/count', [AdminUserController::class, 'count'])->middleware(['auth', 'is_admin']);
Route::get('/admin/chevaux/count', [AdminChevalController::class, 'count'])->middleware(['auth', 'is_admin']);
...
// Ajouter un cheval
Route::post('/horses', [HorseController::class, 'store'])->middleware(['auth', 'is_admin']);

Route::get('/admin', function () {
    return view('admin.index');
})->middleware(['auth', 'is_admin'])->name('admin.dashboard');

Route::delete('/admin/chevaux/{id}', [HorseController::class, 'destroy'])->middleware(['auth', 'is_admin'])->whereNumber('id');
Route::get('/admin/chevaux/{id}', [HorseController::class, 'show'])->middleware(['auth', 'is_admin'])->whereNumber('id');
Route::put('/admin/chevaux/{id}', [HorseController::class, 'update'])->middleware(['auth', 'is_admin'])->whereNumber('id');
