...
<body>
        ...
        <nav class="main-nav">
            <div class="container">
                <ul class="nav-links">
                    ...
                    <li><a href="#" id="favorites-link"><i class="fas fa-heart"></i> Mes favoris <span id="favorites-count" class="badge">0</span></a></li>
    ...
    <section class="search-section">
        <div class="container">
            <div class="search-header">
                ...
                <p class="subtitle">Gérez votre écurie professionnellement</p>
            </div>
                ...
                <div class="filter-options">
                    <div class="filter-group">
                        ...
                        <select id="race-filter">
                            ...
                            <option value="selle-francais">Selle Français</option>
                            <option value="pur-sang">Pur-sang</option>
                            <option value="trotteur">Trotteur Français</option>
                    ...
                    <div class="filter-group">
                        <label for="age-filter"><i class="fas fa-birthday-cake"></i> Âge :</label>
    ...
    <main class="container">
        <div class="horses-grid" id="horses-list">
            <!-- Les chevaux seront générés par JavaScript -->
        </div>
    ...
    <section class="stats-section">
        <div class="container">
            <h3><i class="fas fa-chart-pie"></i> Vue d'ensemble de l'écurie</h3>
    ...
    <script src="horses-data.js"></script>
</body>
</html>